...
"""
    fetch_material_recycling_rates_data(years_range="2010-2024"; db_path::String)

Fetch env_wastrt (waste treatment) per year using EurostatAPI and write to DuckDB tables `env_wastrt_YYYY`.
"""
function fetch_material_recycling_rates_data(years_range="2010-2024"; db_path::String)
