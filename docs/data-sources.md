...
| **COMEXT CN8** (Eurostat) | Trade flows by CN8 code (imports/exports, intra/extra EU) with supplementary units | `comext_ds_059322_YYYY` | 2002–present | Needed to obtain supplementary (count) units when available |
