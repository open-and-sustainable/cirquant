...
All references live in [`docs/`](docs/):
- [Methodology](docs/methodology.md) – research framing, scope definition, and analytical logic.
- [Configuration Guide](docs/configuration-guide.md) – how to tailor `config/products.toml`.
- [Data Sources](docs/data-sources.md) – PRODCOM/COMEXT coverage, indicators, caveats.
- [Raw Database Schema](docs/database-schema-raw.md) and [Processed Schema](docs/database-schema-processed.md) – DuckDB layouts used across the workflow.
- [Parameters Reference](docs/parameters-reference.md) – meanings and valid ranges of each configurable field.

Use these documents for deeper dives; the README focuses on high-level flow.
...
Derived datasets follow [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) due to restrictions on commercial reuse of the original sources.
